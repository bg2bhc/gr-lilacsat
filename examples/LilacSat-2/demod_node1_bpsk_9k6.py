...
# Title: Demod Node 1: BPSK 9k6
# Author: WEI Mingchuan, BG2BHC
# Description: LilacSat-2 9600 bps BPSK telemetry demodulator. Tested on GRC 3.7.8.
# Generated: Fri May  3 14:25:44 2019
##################################################
...
class demod_node1_bpsk_9k6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lilacsat_plan13_cc_0 = lilacsat.plan13_cc(True, tle_line1, tle_line2, lon, lat, alt, 437200000, samp_rate, False, True)
        ...
        self.lilacsat_fec_decode_b_0_0 = lilacsat.fec_decode_b(114, True, False, False)
        ...
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0, 'out'), (self.lilacsat_kiss_decode_pdu_0, 'in'))
        self.msg_connect((self.lilacsat_kiss_decode_pdu_0, 'out'), (self.blocks_message_debug_1, 'print_pdu'))
...
def main(top_block_cls=demod_node1_bpsk_9k6, options=None):

...
class demod_asrtu1_uhd(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demod ASRTU-1 UHD")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demod ASRTU-1 UHD")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demod_asrtu1_uhd")
        ...
        self.lilacsat_plan13_cc_0 = lilacsat.plan13_cc(True, tle_line1, tle_line2, lon, lat, alt, fc-if_freq, if_rate, False, False)
...
def main(top_block_cls=demod_asrtu1_uhd, options=None):

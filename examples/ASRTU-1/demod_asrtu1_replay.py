...
class demod_asrtu1_replay(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demod ASRTU-1 Replay")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demod ASRTU-1 Replay")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demod_asrtu1_replay")
        ...
        self.top_grid_layout.addWidget(self.tab, 0, 1, 4, 1)
        for r in range(0, 4):
        ...
        self._fc_options = [435460000.0, 436270000.0]
        # Create the labels list
        self._fc_labels = ['435.4 MHz', '436.21 MHz']
        # Create the combo box
        self._fc_tool_bar = Qt.QToolBar(self)
        self._fc_tool_bar.addWidget(Qt.QLabel('RX Frequency' + ": "))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/lilac/asrtu-1_20241010.raw', True, 0, 0)
...
def main(top_block_cls=demod_asrtu1_replay, options=None):

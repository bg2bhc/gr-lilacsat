...
satellite_channel_cc::sptr satellite_channel_cc::make(float r_semi_long_axis,
                                                      float alpha_aos,
                                                      float fc,
                                                      float samp_rate,
                                                      float d0,
                                                      ...
                                                      bool link_loss,
                                                      bool verbose) {
    return gnuradio::make_block_sptr<satellite_channel_cc_impl>(
        r_semi_long_axis, alpha_aos, fc, samp_rate, d0, doppler, link_loss, verbose);
}
 ...
 */
satellite_channel_cc_impl::satellite_channel_cc_impl(float r_semi_long_axis,
                                                     float alpha_aos,
                                                     float fc,
                                                     float samp_rate,
                                                     float d0,
...
int satellite_channel_cc_impl::work(int noutput_items,

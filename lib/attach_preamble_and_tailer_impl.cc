...
attach_preamble_and_tailer::make(int len_preamble, int len_tailer, bool padding_type) {
 ...
 */
attach_preamble_and_tailer_impl::attach_preamble_and_tailer_impl(int len_preamble,
                                                                 int len_tailer,
                                                                 bool padding_type)
...
int attach_preamble_and_tailer_impl::work(int noutput_items,
